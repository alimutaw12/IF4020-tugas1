...
class PlayfairCipher:
    ...
    def encrypt(self, plain_text, key):
        ...
        plain_text = self.addX(plain_text)
        # print(plain_text)
        bigram_array = self.generateBigram(plain_text)
        # print(bigram_array)

        key_map = np.array(self.generateKeyMatrix(key))
        cipher_text = ''
    ...
    def decrypt(self, cipher_text, key):
        bigram_array = self.generateBigram(cipher_text)
        # print(bigram_array)
        key_map = np.array(self.generateKeyMatrix(key))
        plain_text = ''
        ...
        for i in range(len(bigram_array)):
            ...
            plain_text = self.removeX(plain_text)
...
# print("key matrix: \n", algo.generateKeyMatrix(key))
# cipher_text = algo.encrypt(plain_text, key)
# print("cipher teks: ", cipher_text, "\n")
# print("plain teks: ", algo.decrypt(cipher_text, key))